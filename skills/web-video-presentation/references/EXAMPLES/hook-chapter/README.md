...
> ⚠️ **这是结构示意，不是抄袭模板**。先走 [`../../CRAFT.md`](../../CRAFT.md)
> ①-⑤。本 anchor 给的是"钩子型开场的结构骨架"——你要保留它的
> step 切分逻辑、字号关系、布局原则，**按本项目的主题 + 内容换动作
> 选型**。倒过来照抄 = [`../../CRAFT.md`](../../CRAFT.md)
> ④「反 AI 味」的同质化反模式（整章只用一种入场动画）。
...
口播会**逐个念出来** —— 必须 1 项 = 1 step（[CRAFT.md ① 铁律 2](../../CRAFT.md)）。
