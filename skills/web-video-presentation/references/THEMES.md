...
24 套主题（脚手架默认 `creator-dark`），每个都有**独立的设计 DNA** —— 不是简单的换色版。挑一个
...
| id                | 性格                                                                                                                                                                                                            |
| ----------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `creator-dark` ⭐ | **脚手架默认主题**。近黑底 + 左上绿色径向辉光 + 发丝网格 + 电光黄绿（#c9ff3a）accent。Archivo Black 粗黑大数字 + 黑体中文（PingFang / Noto Sans SC）+ Inter grotesk。**黄绿当大字 / 填充 / 卡片顶边 + 绿辉光 + 网格**是签名。snappy 节奏（420/680ms）。从创作者自己的评测网页提炼。 |
...
> [`CRAFT.md`](CRAFT.md) 统一规定，与具体主题无关。
