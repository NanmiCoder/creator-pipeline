...
Turn final audio and SRT into a 16:9 web presentation with persistent scenes, meaningful motion and an audio-driven timeline. Start with [SKILL.md](SKILL.md).

Install with `npx skills add NanmiCoder/creator-pipeline --skill web-video-presentation`.
